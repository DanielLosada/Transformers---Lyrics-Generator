...
if __name__ == "__main__":
    ...
    parser.add_argument("-gm", "--generateMultipleArtist", dest='generate_multiple_artist',type=str, help="Pass the artist name to generate lyrics with the model trained with multiple artistrs. Use the same name you used to train it.")
    parser.add_argument("-d", "--datasetSelection", dest='dataset_selection', choices=["genious-lyrics","79-musical-genres"], help="Offers dataset selection between two choices")
