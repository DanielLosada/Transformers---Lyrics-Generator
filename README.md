...
### 6.4 Experiment 5: Performance evaluation GPT-2 vs fine tuned GPT-2 <a name="experiment_5"></a>
...
Conclusions : BLEU score in indeed higher in lyrics generated by the fine-tuned model, it suggests that the fine-tuned model has improved in generating lyrics that are more similar to the reference lyrics.
